...
int main()
{
	...
	/*FragmentLinkedList<int> fList;
	 ...
	 for(FragmentLinkedList<int>::Iterator it = fList.begin(); it != fList.end(3); it++)
		 cout << *it << " ";
	 cout << endl;*/

	 //FragmentLinkedList<int> fList;
	 //for (int i = 0; i < 13; i++) fList.add(i+1);
	 //cout << fList.toString();
	 //cout << endl;
	 ////FragmentLinkedList<int>::Iterator i = fList.end(1);
	 ///*for (FragmentLinkedList<int>::Iterator v = fList.begin(); v != fList.end(5); v++)
	 //{
	 //	cout << *v << " ";

	 //}*/
	 //FragmentLinkedList<int>::Iterator v = fList.begin(4);
	 //cout << *v;
	 //cout << endl;
	 //cout << fList.toString();
	 // === END: Example
	...
	for (int i = 0; i < 16; i++)
		fList.add(i);
	int n = 0;
	for (FragmentLinkedList<int>::Iterator it = fList.begin(2); it != fList.end(4); it++)
	{
		cout << *it << " ";
	...
	//}
	//
	////FragmentLinkedList<int>::Iterator a = l.end(1);
	////for (FragmentLinkedList<int>::Iterator v = l.begin(); v != l.end(); v++) cout << *v << " ";
	//
	//cout << l.toString();
	/*FragmentLinkedList<int> fList(5);
	for (int i = 0; i < 20; i++)
	...
	for (FragmentLinkedList<int>::Iterator v = l.begin(); v != l.end(); v++)
	{
		if (*v > 0 && *v % 3 == 0) v.remove();
	}
	cout << endl;
	cout << l.size() << endl;
	cout << l.toString();*/
